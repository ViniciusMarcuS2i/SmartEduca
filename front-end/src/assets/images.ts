...
export const userIcon = require("./userIcon.jpg");
export const boletim = require("./boletim.png");
export const calendar = require("./calenda.png");
export const bell = require("./packard-bell.png");
